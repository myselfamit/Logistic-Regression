train<-read.csv("F:/R and Data Science/Logistics Regression/Titanic Data/train.csv")
test<-read.csv("F:/R and Data Science/Logistics Regression/Titanic Data/test.csv")
test_1<-read.csv("F:/R and Data Science/Logistics Regression/Titanic Data/test_1.csv")
